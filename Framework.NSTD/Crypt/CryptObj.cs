...
namespace Honjo.Framework.Crypt
{
    ...
    public class CryptObj<T>
    {
        ...
        protected ICryptHelper _Helper
        {
            ...
            {
                if (_helper == null)
                    _helper = EncryptionBase.Get(_Encryption).Helper;
                return _helper;
            }
        ...
        public CryptObj(EncryptionBase method, T obj, ICipherParameters ckey, Func<T, byte[]> encodeFunc)
        {
            _Encryption = method.Id;
    ...
    public class CryptString : CryptObj<string>
    {
        ...
        public CryptString(EncryptionBase method, string obj, ICipherParameters ckey, Encoding encoding) : base(method, obj, ckey, encoding.GetBytes)
        {}
        ...
        /// <param name="obj">String to store</param>
        /// <param name="ckey">Encrypting key</param>
        public CryptString(EncryptionBase method, string obj, ICipherParameters ckey) : this(method, obj, ckey, Encoding.UTF8)
        {}
