...
namespace Honjo.Framework.Crypt.Hashing
{
    ...
    public static class Bcrypt
    {
        ...
        public static string Hash(string str, int rounds = 10) => BCrypt.Net.BCrypt.HashPassword(str, rounds);
        ...
        public static string Salt(int factor = 10) => BCrypt.Net.BCrypt.GenerateSalt(factor);
