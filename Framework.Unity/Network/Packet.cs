...
namespace Honjo.Framework.Network.Packets
{
    ...
    /// </summary>
    [Serializable, ProtoContract(ImplicitFields = ImplicitFields.None)]
    ...
    public class Packet
    {
        ...
        /// </summary>
        public static Serialization DEFAULT_SERIALIZATION = Serialization.PROTOBUF;
        /// <summary>
